...
describe('API Endpoints Integration Tests', () => {
  ...
  beforeAll(async () => {
    ...
    app.get('/api/discounts/collections/search', discountController.searchCollections);
    app.get('/api/discounts/variants', discountController.getAllVariants);
    app.get('/api/discounts/variants/search', discountController.searchVariants);
    app.get('/api/discounts/filter-metadata', discountController.getFilterMetadata);
  ...
  describe('Discount Stacks CRUD', () => {
    ...
    it('should validate BOGO configuration on creation', async () => {
      ...
      expect(response.body.error).toContain('buyQuantity must be greater than 0');
    });
    ...
    it('should auto-set free products when not specified', async () => {
      ...
      expect(response.body.discounts[0].bogoConfig.freeProductIds).toEqual(['123', '456']);
    });
  ...
  describe('Error Handling', () => {
    it('should handle database connection errors gracefully', async () => {
      ...
      DiscountStack.find = jest.fn().mockRejectedValue(new Error('Database connection error'));
